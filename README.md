# 'Get data from NIST/JANAF without interpolation' Repository
...
```bash
 git clone -c core.longpaths=true https://github.com/nduursma/Get-data-from-NIST-without-interpolation
```
Change your working directory.
```bash
cd Get-data-from-NIST-without-interpolation
```
...
![The datafields.](https://github.com/nduursma/Get-data-from-NIST-without-interpolation/blob/main/enterdata.PNG)
...
![Find the right formula and phase.](https://github.com/nduursma/Get-data-from-NIST-without-interpolation/blob/main/formulatable.PNG)

After choosing the right molecular formula and phase, you will find the thermochemical properties.

![Output of the thermochemical properties.](https://github.com/nduursma/Get-data-from-NIST-without-interpolation/blob/main/output.PNG)
